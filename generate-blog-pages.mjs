...
const SITE_URL = "https://www.romagna-affitti-brevi.it";
...
// Stessa sintassi e stessa implementazione validate su Casa Cavour IT/EN/NL,
// interpretata anche dal rendering React live (src/App.jsx).
...
function renderPage(post, idToSlug) {
  ...
  const title = `${post.titolo} | Romagna Affitti Brevi`;
  ...
  const jsonLd = {
    ...
    "author": { "@type": "Organization", "name": "Romagna Affitti Brevi" },
    "publisher": {
      "@type": "Organization",
      "name": "Romagna Affitti Brevi",
      "url": SITE_URL,
    },
  };
...
<html lang="it">
  <head>
    ...
    <meta property="og:site_name" content="Romagna Affitti Brevi" />
  ...
  <body>
    <div class="wrap">
      <div class="top-nav">
        <a href="${SITE_URL}/#blog">← Torna al sito Romagna Affitti Brevi</a>
...
${bodyBlocks}
      <div class="ig-cta">
        <p>Seguici su Instagram per non perderti le nuove strutture e i contenuti sulla Romagna.</p>
